...
keys_64bits = "0100110001001111010101100100010101000011010100110100111001000100" 
keys_56bits = apply_PC1(PC1,keys_64bits)

def split_in_half(keys_56bits):
    #Split the 56 bits key into two equal halves
...
def circular_left_shift(bits,numberofbits):
    #circularly shift the given bit string according to the number of bits
